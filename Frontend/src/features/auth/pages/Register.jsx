      ...
      <div className="flex flex-col md:flex-row flex-1 md:overflow-hidden">
        ...
        <div className="w-full md:w-1/2 bg-[#111111] flex items-center justify-center px-8 sm:px-14 py-10 md:overflow-y-auto">
          <div className="w-full max-w-md">
            ...
            {/* Heading */}
            <div className="mb-6">
              <h1 className="text-white text-2xl font-semibold mb-1">Begin your journey.</h1>
              <p className="text-[#6b6b6b] text-sm">Join the exclusive world of Snitch Atelier.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-3 pt-1">
                ...
                <span className="text-[#6b6b6b] text-sm select-none cursor-pointer" onClick={handleCheckbox}>
                  Register as Seller
                </span>
              </div>
            ...
            <div className="flex items-center gap-4 my-5">
              ...
              <span className="text-[#3a3a3a] text-[10px] tracking-[0.15em] uppercase">Or Join With</span>
              <div className="flex-1 h-px bg-[#222]" />
            </div>
            ...
            <div className="flex justify-center">
              <a href="/api/auth/google">
                <button
                type="button"
                className="flex items-center justify-center gap-2.5 py-3 px-10 cursor-pointer border border-[#2a2a2a] text-[#aaaaaa] hover:border-[#3a3a3a] hover:text-white transition-all duration-200 bg-[#161616] hover:bg-[#1a1a1a]"
              >
                <GoogleIcon />
              ...
              {/* <button
                type="button"
                className="flex items-center justify-center gap-2.5 py-3 border border-[#2a2a2a] text-[#aaaaaa] hover:border-[#3a3a3a] hover:text-white transition-all duration-200 bg-[#161616] hover:bg-[#1a1a1a]"
              >
                <AppleIcon />
            ...
            <p className="text-center text-[#4a4a4a] text-sm mt-6">
              ...
              <Link to='/login' className="text-[#c9a84c] hover:text-[#e2c46a] transition-colors duration-200 font-medium">
                Login
              </Link>
            </p>
